...
/**
 * Icons for item categories (using Lucide icon names from @tamagui/lucide-icons)
 */
...
/**
 * Colors for item categories (Tamagui color tokens)
 */
 ...
 */
export const CATEGORY_CONFIG: Record<ItemCategory, { label: string; icon: string; color: string }> = {
  book: { label: CATEGORY_LABELS.book, icon: CATEGORY_ICONS.book, color: CATEGORY_COLORS.book },
  tool: { label: CATEGORY_LABELS.tool, icon: CATEGORY_ICONS.tool, color: CATEGORY_COLORS.tool },
  clothing: { label: CATEGORY_LABELS.clothing, icon: CATEGORY_ICONS.clothing, color: CATEGORY_COLORS.clothing },
  electronics: { label: CATEGORY_LABELS.electronics, icon: CATEGORY_ICONS.electronics, color: CATEGORY_COLORS.electronics },
  game: { label: CATEGORY_LABELS.game, icon: CATEGORY_ICONS.game, color: CATEGORY_COLORS.game },
  sports: { label: CATEGORY_LABELS.sports, icon: CATEGORY_ICONS.sports, color: CATEGORY_COLORS.sports },
  kitchen: { label: CATEGORY_LABELS.kitchen, icon: CATEGORY_ICONS.kitchen, color: CATEGORY_COLORS.kitchen },
  other: { label: CATEGORY_LABELS.other, icon: CATEGORY_ICONS.other, color: CATEGORY_COLORS.other },
}
